...
clear_disp();
return_home();
enviar_inst_8bits(0b00000100 | 0b00000010 | 0b00000000);
enviar_inst_8bits(0b00001100 | 0b00001110 | 0b00001001);
enviar_inst_8bits(0b00110000 | 0b00101000 | 0b00100000);
}
...
if (y == 0)
{
enviar_inst_8bits(0b10000000 | x + 0x40);
}
else if (y == 1)
{
enviar_inst_8bits(0b10000000 | x);
}
}
void write_DDRAM(char character)
{
...
direccionCGRAM *= 8;
enviar_inst_8bits(0b01000000|direccionCGRAM);
printCGRAM(dirSpecialChar);
enviar_inst_8bits(0b10000000|DDRAM_add);
}
