...
void enviar_inst_4bits(unsigned char instruction)
{
    ...
    PORTDbits.RD0 = instruction1 & 0x01;
    PORTDbits.RD1 = (instruction1 & 0x02) >> 1;
    PORTDbits.RD2 = (instruction1 & 0x04) >> 2;
    PORTDbits.RD3 = (instruction1 & 0x08) >> 3;
    exec_time2();
    PORTDbits.RD0 = instruction2 & 0x01;
    PORTDbits.RD1 = (instruction2 & 0x02) >> 1;
    PORTDbits.RD2 = (instruction2 & 0x04) >> 2;
    PORTDbits.RD3 = (instruction2 & 0x08) >> 3;
    exec_time2();
    PORTDbits.RD0 = 0;
    PORTDbits.RD1 = 0;
    PORTDbits.RD2 = 0;
...
void Init_LCD(void)
{
    ...
    clear_disp();
    return_home();
    enviar_inst_4bits(0b00100000 | 0b00101000 | 0b00100000);
    enviar_inst_4bits(0b00000100 | 0b00000010 | 0b00000000);
    enviar_inst_4bits(0b00001100 | 0b00001110 | 0b00001001);
}
...
void gotoxy(unsigned char y, unsigned char x)
{
    ...
    if (y == 0)
    {
 enviar_inst_4bits(0b10000000 | x + 0x40);
    }
    else if (y == 1)
    {
 enviar_inst_4bits(0b10000000 | x);
    }
}
