...
void LCD_Init(void){
    ...
    PORTBbits.RB1=0;PORTBbits.RB2=0;PORTBbits.RB3=0;
    TRISB = 0x01;
...
void escribir_comando(char comando){
    PORTB = (comando)&0xF0;
    LCD_delay();PORTBbits.RB3 = 1;LCD_delay();PORTBbits.RB3 = 0;LCD_delay();
    PORTB = (comando<<4)&0xF0;
    LCD_delay();PORTBbits.RB3 = 1;LCD_delay();PORTBbits.RB3 = 0;LCD_delay();
    PORTB = 0x00;
}
void escribir_caracter(char caracter){
    PORTB = (caracter)&0xF0;
    PORTBbits.RB1 = 1; LCD_delay();PORTBbits.RB3 = 1;LCD_delay();PORTBbits.RB3 = 0;LCD_delay();PORTBbits.RB1 = 0;
    PORTB = (caracter<<4)&0xF0;
    PORTBbits.RB1 = 1;LCD_delay();PORTBbits.RB3 = 1;LCD_delay();PORTBbits.RB3 = 0;LCD_delay();PORTBbits.RB1 = 0;
    PORTB = 0x00;
}
void escribir_cadena(char *cadena){
...
char leer_direccion_DDRAM(void){
    TRISB=0xF0;
    PORTBbits.RB2=1; LCD_delay();PORTBbits.RB3=1;LCD_delay();
    direccion_DDRAM=(PORTB&0xF0);
    PORTBbits.RB3=0;LCD_delay();PORTBbits.RB3=1;LCD_delay();
    direccion_DDRAM=(((PORTB&0xF0)>>4)&0x0F)|direccion_DDRAM;
    PORTBbits.RB3=0;PORTBbits.RB2=0;LCD_delay();
    TRISB=0x00;
