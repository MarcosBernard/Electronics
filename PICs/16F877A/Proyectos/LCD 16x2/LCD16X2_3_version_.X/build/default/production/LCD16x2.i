...
void LCD_Init(void){
    ...
    PORTD |= 0x00;
    PORTD = 0b00000010;
    PORTDbits.RD7 = 1;LCD_delay();
    PORTDbits.RD7 = 0;LCD_delay();
}
void escribir_comando(char comando){
    PORTD = (comando>>4)&0x0F;
    LCD_delay();PORTDbits.RD7 = 1;LCD_delay();PORTDbits.RD7 = 0;LCD_delay();
    PORTD = (comando)&0x0F;
    LCD_delay();PORTDbits.RD7 = 1;LCD_delay();PORTDbits.RD7 = 0;LCD_delay();
}
void escribir_caracter(char caracter){
    PORTD = (caracter>>4)&0x0F;
    PORTDbits.RD5 = 1; LCD_delay();PORTDbits.RD7 = 1;LCD_delay();PORTDbits.RD7 = 0;LCD_delay();PORTDbits.RD5 = 0;
    PORTD = (caracter)&0x0F;
    PORTDbits.RD5 = 1;LCD_delay();PORTDbits.RD7 = 1;LCD_delay();PORTDbits.RD7 = 0;LCD_delay();PORTDbits.RD5 = 0;
}
void escribir_cadena(char *cadena){
...
char leer_direccion_DDRAM(void){
    TRISD=0x0F;
    PORTDbits.RD6=1; LCD_delay();PORTDbits.RD7=1;LCD_delay();
    direccion_DDRAM=((PORTD&0x0F)<<4)&0xF0;
    PORTDbits.RD7=0;LCD_delay();PORTDbits.RD7=1;LCD_delay();
    direccion_DDRAM=(PORTD&0x0F)|direccion_DDRAM;
    PORTDbits.RD7=0;PORTDbits.RD6=0;LCD_delay();
    TRISD=0x00;
